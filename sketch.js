...
function setup() {
	...
	rope1 = new Chain(bobObject1.body,ground.body,2,0)
	rope2 = new Chain(bobObject2.body,ground.body,2,0)
	rope3 = new Chain(bobObject3.body,ground.body,2,0)
	rope4 = new Chain(bobObject4.body,ground.body,2,0)
	rope5 = new Chain(bobObject5.body,ground.body,5,0)
